            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number">
                    <?php echo number_format($iB_deposits); ?> vnd
                  </span>
                </div>
              </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number"> <?php echo number_format($iB_withdrawal); ?> vnd</span>
                </div>
              </div>
            </div>
            <!-- Withdrawals-->
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number"> <?php echo number_format($iB_Transfers); ?> vnd</span>
                </div>
              </div>
            </div>
            <!-- /.Transfers-->
